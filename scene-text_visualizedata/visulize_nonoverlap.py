...
txt_list = list_file(r'/home/lynm/Desktop/postprocess_baai/non_overlap')
...
def visulize(img_path, txt_path):
    ...
    cv2.imwrite(r'/home/lynm/Desktop/postprocess_baai/scene-text_visualizedata/visualize_predict_nonoverlap/' + img_path.split('/')[-1], img)
    print('/home/lynm/Desktop/postprocess_baai/scene-text_visualizedata/visulize_predict_nonoverlap/' + img_path.split('/')[-1])



for i in txt_list:
    img_name = i[:-28] + '/scene-text_visualizedata/public_test_img/' + i.split('/')[-1][4:-3] + 'jpg'
